    ...
    getExistingLeads()
      .then((data) => {
        if (data.leads?.length > 0) {
          setLeads(data.leads);
          setLogs([
            `Loaded ${data.leads.length} existing leads from ${data.file}`,
          ]);
        }
      })
      .catch(() => {
        ...
        <section className="island-shell rounded-2xl p-8 text-center">
          <div className="mx-auto max-w-md">
            ...
            <p className="mb-6 text-[var(--sea-ink-soft)]">
              Click "Run Lead Generator" to scrape recent probate filings from
              Harris County and match them against HCAD property records.
            </p>
